/**
 * Anthropometry.tsx — Antropometría
    ...
    <div className="max-w-2xl mx-auto px-4 pt-6 pb-4 md:px-6 md:pt-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-[color:var(--color-text-secondary)] leading-relaxed ml-[52px]">
          IMC, peso ideal, pliegues cutáneos y composición corporal.
        </p>
      </div>
      <div className="rounded-2xl border-2 border-dashed border-[color:var(--color-border)] flex flex-col items-center justify-center py-16 px-6 text-center">
        <div className="w-14 h-14 rounded-2xl bg-purple-50 flex items-center justify-center text-purple-400 mb-4">
          <Ruler size={28} />
        </div>
        ...
        <div className="mt-5 px-4 py-2 rounded-full bg-purple-50 text-purple-600 text-xs font-semibold tracking-wide">
          PRÓXIMAMENTE
        </div>
      </div>
    </div>
