    ...
    <div className="max-w-2xl mx-auto px-4 pt-6 pb-4 md:px-6 md:pt-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-[color:var(--color-text-secondary)] leading-relaxed ml-[52px]">
          Registro e interpretación de glucosa, HbA1c, perfil lipídico, función renal y hepática.
        </p>
      </div>
      <div className="rounded-2xl border-2 border-dashed border-[color:var(--color-border)] flex flex-col items-center justify-center py-16 px-6 text-center">
        <div className="w-14 h-14 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-400 mb-4">
        ...
        <div className="mt-5 px-4 py-2 rounded-full bg-emerald-50 text-emerald-600 text-xs font-semibold tracking-wide">
          PRÓXIMAMENTE
        </div>
      </div>
    </div>
